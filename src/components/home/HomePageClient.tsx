...
function CompactConsumableCard({
  product,
  rateBcv,
}: CompactConsumableCardProps) {
    ...
    <div className="group relative bg-slate-800 border border-slate-700/50 hover:bg-slate-800/80 rounded-xl p-4 flex flex-col justify-between min-h-[240px] transition-all duration-200 shadow-sm flex-none w-[85vw] sm:w-[320px] md:w-auto snap-center md:snap-align-none">
      <div className="flex flex-col gap-2">
        ...
        {product.volumeDiscount && (
          <div
            className={`mt-1.5 p-2 rounded-lg text-[11px] leading-snug border transition-all duration-200 ${
              isVolumePrice
      ...
      <div className="flex flex-col gap-3 mt-4 border-t border-slate-700/30 pt-3">
        <div className="flex items-center justify-between gap-2">
          <div className="flex flex-col">
            ...
            <div
              key={`${rateBcv}-${rateBinance}`}
              className="animate-blur-pop"
            >
        ...
        {added ? (
          ...
          >
            <Check className="h-3.5 w-3.5 stroke-[3px]" /> ¡Agregado +
            {addedQty}!
          </button>
        ) : (
          <button
...
export default function HomePageClient() {
  ...
  const handleSearch = React.useCallback((query: string) => {
    ...
    if (query.trim() !== "") setShowAllCatalog(true);
  }, []);
  ...
  return (
    <div className="print:hidden">
      ...
      <section
        id="marcas"
        aria-label="Marcas aliadas y distribuidores"
        className="relative w-full py-6 border-t border-b border-slate-800 bg-slate-950/20 print:hidden overflow-hidden flex"
      >
        <div className="w-full flex flex-col items-center">
          ...
          <div className="overflow-hidden relative w-full flex">
            ...
            <div className="flex animate-[scroll_150s_linear_infinite] hover:[animation-play-state:paused] gap-12 md:gap-16">
              ...
              <div
                className="flex items-center justify-around gap-12 md:gap-16 min-w-max shrink-0"
                aria-hidden="true"
              >
                {BRANDS.map((brand, idx) => (
                  <div
      ...
      <main
        role="main"
        className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-12 mt-12 pb-24 md:pb-16 relative"
      >
        <article>
          {/* Comprar por Tipo de Proyecto */}
          <section
            aria-label="Categorías de productos por tipo de proyecto"
            className="w-full py-2 border-b border-slate-800/80"
          >
            <div className="flex flex-col gap-2 mb-8 text-center items-center">
              ...
              <p className="text-xs text-slate-400 max-w-xl">
                Selecciona la especialidad de tu obra para filtrar insumos
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col gap-2.5 max-w-xl">
                  ...
                  <h3 className="font-display text-xl md:text-2xl font-bold text-slate-100 group-hover:text-[#007BFF] transition-colors duration-200">
                    Canalización y Cableado para Obras Civiles
                  </h3>
                  <p className="text-xs text-slate-350 leading-relaxed">
                    Tubería PVC autoextinguible, rollos de cable THHN de cobre
                    electrolítico de alto calibre (10/12 AWG) y sistemas de
                    distribución de potencia media.
                  </p>
                  <div className="mt-2 flex items-center gap-1.5 font-mono text-[10px] font-bold text-slate-400 group-hover:text-slate-200 transition-colors">
                    Ver Catálogo de Material Pesado{" "}
                    <ArrowRight className="h-3 w-3 transition-transform duration-200 group-hover:translate-x-1" />
                  </div>
                </div>
              </div>

              {/* Panel B: Iluminación LED */}
              <div
              ...
              >
                ...
                <div className="relative z-10 flex flex-col gap-2">
                  ...
                  <h3 className="font-display text-base font-bold text-slate-100 group-hover:text-[#007BFF] transition-colors duration-200">
                    Iluminación LED: Reflectores, Paneles y Bombillos
                  </h3>
                  <p className="text-[11px] text-slate-400 leading-relaxed line-clamp-2">
                    Reflectores IP66 de alta potencia, paneles empotrables y
                    bombillos ahorradores para urbanismo y galpones.
                  </p>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col gap-2">
                  ...
                  <h3 className="font-display text-base font-bold text-slate-100 group-hover:text-[#007BFF] transition-colors duration-200">
                    Interruptores Termomagnéticos y Control Industrial
                  </h3>
                  <p className="text-[11px] text-slate-400 leading-relaxed line-clamp-2">
                    Tableros eléctricos para empotrar, breakers QO Schneider y
                    dispositivos de maniobra para uso residencial e industrial.
                  </p>
                  <div className="mt-1 flex items-center gap-1.5 font-mono text-[10px] font-bold text-slate-400 group-hover:text-slate-200 transition-colors">
                    Ver Sistemas de Control{" "}
                    <ArrowRight className="h-3 w-3 transition-transform duration-200 group-hover:translate-x-1" />
                  </div>
                </div>
              </div>
          ...
          {/* Beneficios — Server Component insertado */}
          <BenefitsSection />

          {/* Consumibles de Alta Rotación */}
          <section
            aria-label="Consumibles básicos de obra con precios al mayor"
            className="w-full max-w-full overflow-hidden py-2 border-b border-slate-800/80"
          >
            <div className="flex flex-col gap-2 mb-8 text-center items-center">
              <span className="text-[9px] font-mono font-bold text-slate-500 uppercase tracking-widest flex items-center gap-1.5 justify-center">
                <Sparkles className="h-3 w-3 text-[#007BFF]" /> MAYORISTAS Y
                CONTRATISTAS
              </span>
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full">
                <div className="flex flex-col gap-1 items-center">
                  ...
                  <p className="text-xs text-slate-400 text-center max-w-xl">
                    Ahorra en insumos de alta rotación. Agrega paquetes
                    completos con precios especiales por volumen a un solo clic.
                  </p>
                </div>
            ...
            <div className="flex overflow-x-auto gap-4 px-4 md:px-0 md:grid md:grid-cols-3 md:overflow-visible pb-8 snap-x snap-mandatory scroll-smooth scrollbar-hide">
              {isFetchingData
                ? [1, 2, 3].map((n) => (
                    <div
                      key={n}
                      className="bg-slate-800 border border-slate-700/50 rounded-xl p-4 animate-pulse min-h-[240px] w-[85vw] sm:w-[320px] md:w-auto flex flex-col justify-between"
                    >
                      <div className="flex flex-col gap-2">
          ...
          {/* Proceso de Compra */}
          <section
            aria-label="Proceso de compra en tres pasos"
            className="relative z-10 w-full border-t border-b border-slate-800 bg-slate-950/20 py-6"
          >
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
              <div className="flex flex-col gap-3.5 items-center text-center">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[11px] text-slate-450 leading-relaxed mt-1 max-w-xs">
                    Explora nuestro catálogo con precios y tasas oficiales BCV en
                    tiempo real.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3.5 items-center text-center border-t md:border-t-0 md:border-l border-slate-800 pt-4 md:pt-0 md:pl-6">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[11px] text-slate-450 leading-relaxed mt-1 max-w-xs">
                    Fracciona tu pago combinando efectivo, zelle, pago móvil o
                    transferencias.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3.5 items-center text-center border-t md:border-t-0 md:border-l border-slate-800 pt-4 md:pt-0 md:pl-6">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[11px] text-slate-450 leading-relaxed mt-1 max-w-xs">
                    Confirma al WhatsApp y retira en tienda física o recibe vía
                    delivery local.
                  </p>
                </div>
              </div>
          ...
          <section
            aria-label="Catálogo completo de productos"
            id="catalogo"
          ...
          >
            <div className="flex flex-col gap-2 mb-6 text-center items-center">
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full">
                <div className="flex flex-col gap-1 items-center">
                  <h2 className="font-display text-2xl font-bold tracking-tight text-slate-100 text-center">
                    Catálogo de Materiales Eléctricos y Ferretería
                  </h2>
                  <p className="text-xs text-slate-450 text-center max-w-xl">
                    Precios dinámicos liquidados en dólares o bolívares al cambio
                    del Banco Central.
                  </p>
                </div>
                <span className="md:hidden flex items-center gap-1 text-[9px] font-mono font-bold text-[#007BFF] uppercase tracking-wider bg-slate-950/40 border border-slate-800 px-2.5 py-1 rounded-full shrink-0 select-none animate-pulse">
            ...
            <ProductGrid
              ...
              limit={showAllCatalog ? undefined : 6}
            />
            ...
            {!showAllCatalog && (
              <div className="flex justify-center mt-12 mb-20">
                ...
                >
                  Ver Catálogo de Suministros completo{" "}
          ...
          {/* Ubicación y Tienda Física */}
          <section
            id="ubicacion"
            aria-label="Ubicación de la tienda física en Charallave"
            className="relative z-10 w-full flex flex-col gap-6 py-4 print:hidden text-center items-center"
          >
                    ...
                    <div className="flex flex-col gap-2 items-center text-center">
                      ...
                      <div className="flex flex-col gap-1 items-center">
                        ...
                        <p className="text-xs text-slate-200 leading-relaxed font-medium">
                          Calle 15 Miranda, frente al Concejo, Charallave.
                          Municipio Cristóbal Rojas, Estado Miranda. Venezuela
                          1210.
                        </p>
                        <p className="text-[11px] text-slate-400 leading-relaxed mt-1 max-w-sm">
                          Ubicados en la zona céntrica comercial, ven y verifica
                          todos nuestros conectores e iluminación LED en el
                          mostrador.
                        </p>
                      </div>
                    </div>
              ...
              <div className="md:col-span-7">
                <div className="relative w-full h-full min-h-[320px] overflow-hidden rounded-xl border border-slate-800">
                  <iframe
                    ...
                    title="Google Maps - Suministros L&D en Charallave"
                  />
                </div>
              </div>
            </div>
